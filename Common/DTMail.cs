...
namespace WXGateway.Models
{
    public class DTMail
    {
        ...
        public static void sendMail(string smtpserver, string enablessl, string userName, string pwd, string nickName, string strfrom, string strto, string subj, string bodys)
        {
